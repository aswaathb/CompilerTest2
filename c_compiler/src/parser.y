...
%type <str> ASSIGNMENT_OP TYPE_NAME IDENTIFIER INCR DECR STRING C_CONST F_CONST I_CONST SIZEOF

%type <literal> UNARY_OPERATOR  EQUAL SEMICOLON COMMA L_BRAC R_BRAC L_CURLY R_CURLY L_SQUARE R_SQUARE QUES_MARK COLON 
